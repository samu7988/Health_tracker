...
//Set Energy mode using the following #define
  ...
  #define APP_IS_OK_TO_SLEEP      (false) //false for EM0 , true for Rest
#else
  #define APP_IS_OK_TO_SLEEP      (true)
#endif

//Clock frequency selection
#define LETIMER_ON_TIME_MICROS (50) //Microsecond

//500 ->0.5 sec, 50-> 0.05 sec, 5->0.005
#define LETIMER_ON_TIME_MS (2) //Five thousand millisecond

#define EIGHTY_MILLISECOND (80000U) //This is the power up time in the datasheet
#define TEN_POINT_EIGHTMS (10800U) //This is the conversion timer(max is 10.8 msec)

#define LETIMER_PERIOD_MS  (6500)
